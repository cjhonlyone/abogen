...
class Job:
    ...
    supertonic_lang: Optional[str] = None
    vibevoice_model: str = "VibeVoice-1.5B"
    vibevoice_diffusion_steps: int = 20
    vibevoice_cfg_scale: float = 1.3
    vibevoice_attention: str = "auto"
    vibevoice_quantize: str = "none"
    ...
    def as_dict(self) -> Dict[str, object]:
        return {
            ...
            "options": {
                ...
                "supertonic_lang": getattr(self, "supertonic_lang", None),
                "vibevoice_model": getattr(self, "vibevoice_model", "VibeVoice-1.5B"),
                "vibevoice_diffusion_steps": getattr(self, "vibevoice_diffusion_steps", 20),
                "vibevoice_cfg_scale": getattr(self, "vibevoice_cfg_scale", 1.3),
                "vibevoice_attention": getattr(self, "vibevoice_attention", "auto"),
                "vibevoice_quantize": getattr(self, "vibevoice_quantize", "none"),
...
class ConversionService:
    ...
    def enqueue(
        ...
        *,
        ...
        job = Job(
            ...
            supertonic_lang=(supertonic_lang or None),
            vibevoice_model=(vibevoice_model or "VibeVoice-1.5B"),
            vibevoice_diffusion_steps=int(vibevoice_diffusion_steps or 20),
            vibevoice_cfg_scale=float(vibevoice_cfg_scale or 1.3),
            vibevoice_attention=(vibevoice_attention or "auto"),
            vibevoice_quantize=(vibevoice_quantize or "none"),
            use_gpu=use_gpu,
    ...
    def _serialize_job(self, job: Job) -> Dict[str, Any]:
        ...
        return {
            ...
            "supertonic_lang": getattr(job, "supertonic_lang", None),
            "vibevoice_model": getattr(job, "vibevoice_model", "VibeVoice-1.5B"),
            "vibevoice_diffusion_steps": getattr(job, "vibevoice_diffusion_steps", 20),
            "vibevoice_cfg_scale": getattr(job, "vibevoice_cfg_scale", 1.3),
            "vibevoice_attention": getattr(job, "vibevoice_attention", "auto"),
            "vibevoice_quantize": getattr(job, "vibevoice_quantize", "none"),
            "use_gpu": job.use_gpu,
            "subtitle_mode": job.subtitle_mode,
            "output_format": job.output_format,
            "save_mode": job.save_mode,
    ...
    def _deserialize_job(self, payload: Dict[str, Any]) -> Job:
        ...
        job = Job(
            ...
            supertonic_lang=payload.get("supertonic_lang"),
            vibevoice_model=str(payload.get("vibevoice_model") or "VibeVoice-1.5B"),
            vibevoice_diffusion_steps=int(payload.get("vibevoice_diffusion_steps", 20)),
            vibevoice_cfg_scale=float(payload.get("vibevoice_cfg_scale", 1.3)),
            vibevoice_attention=str(payload.get("vibevoice_attention") or "auto"),
            vibevoice_quantize=str(payload.get("vibevoice_quantize") or "none"),
